...
# def wavelength_sizing_function(dem, wl=10, max_size=99999.0):
#    """Mesh sizes that vary proportional to an estimate of wavelength of the M2 constituent
#
#    Parameters
#    ----------
#    dem:  :class:`Dem`
#        Data process from :class:`Dem`.
#    wl: integer, optional
