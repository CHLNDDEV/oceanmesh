...
def generate_mesh(domain, cell_size, h0, comm=None, **kwargs):
    ...
    :type domain: A :class:`SignedDistanceFunction` object or a function object.
    :param cell_size:
        Either a :class:`Grid` object or a function that can evalulate a point and return a mesh size.
    :type cell_size: A :class:`Grid` object or a function object.
    :param h0:
